...
const Layout = ({search, setSearch, recipesList, setRecipesList}) => {

const newList = recipesList.filter((recipe) => ( // J'utilise la méthode filter pour filtrer les recettes en focntion des noms inscrits dans la barre de recherche
    ...
    return (
        <div className='Layout'>
            <Header setSearch={setSearch} search={search} setRecipesList={setRecipesList} />
